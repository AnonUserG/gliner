...
- В логи (уровень `INFO`) пишется: на сколько чанков разбит текст, сколько сущностей извлечено из каждого чанка и сколько сущностей получилось после склейки. Для текстов короче `CHUNK_SIZE_WORDS` чанкование не применяется и в логах не отражается.
